...
def load_trec(model_name, glove_fname):
    ...
    feat_LS = np.load('../data/trec/Extracted_Features/lex.npy')
    feat_read = np.load('../data/trec/Extracted_Features/read.npy')
    feat_numeric = np.load('../data/trec/Extracted_Features/numeric.npy')
