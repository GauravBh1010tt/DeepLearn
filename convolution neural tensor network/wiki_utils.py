...
def load_wiki(model_name, glove_fname):
    data_train = open('../data/wiki/WikiQA-train.txt').readlines()
    data_test= open('../data/wiki/WikiQA-test.txt').readlines()
    data_dev = open('../data/wiki/WikiQA-dev.txt').readlines()
    res_fname = '../data/wiki/new_ref'
